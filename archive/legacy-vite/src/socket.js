...
export const initSocket = async () => {
    ...
    const envUrl = (envHasImportMeta && import.meta.env.VITE_BACKEND_URL) || (envHasProcess && process.env.VITE_BACKEND_URL);
    const fallbackLocal = isLocal ? 'http://localhost:5000' : origin;
